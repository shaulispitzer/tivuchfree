...
import { index, store } from '@/routes/admin/streets';
...
<template>
    <Head title="Create street" />

    <div class="flex items-center justify-between">
        <h1 class="text-lg font-semibold">Create street</h1>
    ...
    >
        ...
        <div class="grid gap-2">
            ...
            <Input id="name_en" name="name[en]" required />
            <InputError :message="errors['name.en']" />
        </div>

        <div class="grid gap-2">
            <Label for="name_he">Name (Hebrew)</Label>
            <Input id="name_he" name="name[he]" required />
